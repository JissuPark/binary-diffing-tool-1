...
def exstrings(FILENAME,regex=None):
    ...
    result=list(string_dics.values())+ipaddress_count+email_address_count+url_count+mal_strIng_count+wmi_count+registry_str_count+cmd_count+power_shell_count+[entropys]
